...
let sources = import ../../nix/sources.nix; in {
  ...
  #     whitelist = {
  #       prefix= [
  #         "$HOME/code/go/src/github.com/chengchengmu"
  #       ];
  ...
  programs.git = {
    enable = true;
    userName = "Chengcheng Mu";
    userEmail = "Chengcheng.Mu@gmail.com";
    signing = {
  ...
  #   enable = true;
  #   goPath = "code/go";
  #   goPrivate = [ "github.com/chengchengmu" "github.com/hashicorp" "rfc822.mx" ];
  # };
